...
SECRET_KEY = 'django-insecure-b+s1642xcows(2$us4_ikmhhi$c5_b$a!4b!u04qfs63)tpti$'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "My Bot Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Bot Admin Panel",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Bot Admin Panel",
    ...
    "search_model": ["auth.User", "app.BotUserModel"],
    ...
    "icons": {
        ...
        "app.BotUserModel":"fas fa-robot",
        "app.TelegramChannelModel":"fas fa-users",
    },
